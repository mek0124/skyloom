...
class WeatherEngine:
    ...
    def build_display(self, response: Tuple[bool, Union[dict, str]], user_settings: dict) -> dict:
        try:
            response_dict = {}
    ...
    def display_response(self, response: Tuple[bool, Union[dict, str]], user_settings: dict) -> None:   
        try:
            current_weather = response["current"]
            response_display = self.build_display(current_weather, user_settings)
